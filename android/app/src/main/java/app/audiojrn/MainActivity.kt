...
const val ACTION_OPEN_CAPTURE = "app.audiojrn.OPEN_CAPTURE"
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) { super.onCreate(savedInstanceState)
        ...
        setContent { DiaryApp(viewModel, tasksViewModel, RetrofitBackendRepository(), getSharedPreferences("audiojrn", Context.MODE_PRIVATE), navigation.flow) }
    }
...
@Composable fun AudioJrnScreen(viewModel: CaptureViewModel, preferences: android.content.SharedPreferences) {
