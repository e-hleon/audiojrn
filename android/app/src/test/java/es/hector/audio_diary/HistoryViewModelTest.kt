...
class HistoryViewModelTest {
    ...
    @Test fun search_normalization_and_result_day_use_madrid_timezone() {
        assertEquals("pizarra", transcriptionSearchQuery("  pizarra "))
        assertEquals(null, transcriptionSearchQuery("   "))
        assertEquals(java.time.LocalDate.parse("2026-09-09"), interactionLocalDate("2026-09-08T22:30:00Z"))
    }
}
